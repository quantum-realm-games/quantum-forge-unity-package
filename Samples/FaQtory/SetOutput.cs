...
{
    public class SetOutput : MonoBehaviour
    {
        [SerializeField] private FaQtoryFunction _function;
        
        void OnTriggerEnter(Collider otherCollider)
        {
            var quantumProperty = otherCollider.gameObject.GetComponent<QuantumProperty>();
            _function.SetOutput(quantumProperty);
        }
    }
}
